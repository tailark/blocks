        ...
        <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col justify-center gap-8 px-6 py-16">
            <div className="flex flex-col gap-3">
                ...
                <h1 className="text-4xl font-semibold tracking-tight text-zinc-950">
                    Open source shadcn/ui registry for Tailark.
                </h1>
                <p className="max-w-2xl text-lg leading-8 text-zinc-600">
                    This repository serves the public registry endpoints. The marketing site can
                    live in a separate closed-source app and proxy these paths from the same domain.
                </p>
            </div>
