...
export function Pricing() {
    ...
    return (
        <section
            ...
            <div className="md:mt-15 relative mt-9">
                <div className="relative mx-auto max-w-7xl px-4">
                    <div className="@container">
                        <div className="ring-foreground/10 @max-5xl:overflow-hidden @xl:grid-cols-2 @max-5xl:divide-y @5xl:grid-cols-4 bg-background @xl:divide-x grid rounded-xl ring *:p-6">
                            <div className="row-span-4 grid grid-rows-subgrid gap-8">
                                <div>
                            ...
                            <div className="row-span-4 grid grid-rows-subgrid gap-8 border-r-transparent">
                                <div>
                            ...
                            <div className="bg-card ring-foreground/10 @5xl:-my-3 @5xl:rounded-xl @xl:border-transparent row-span-4 grid grid-rows-subgrid gap-8 shadow-xl shadow-black/5 ring dark:bg-zinc-900">
