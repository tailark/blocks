...
import { HeroHeader } from '@/registry/bases/base/dusk/blocks/hero-section/ten/header'
import LogoCloud from '@/registry/bases/base/dusk/blocks/hero-section/ten/logo-cloud'
