...
const blockItems: Registry["items"] = [
    ...
    block({ category: "faqs", variant: "one", path: "veil/blocks/faqs/one.tsx", dependencies: [ui("card"), ui("accordion")], meta: { "aspect-ratio": "9/4", width: 686, height: 305 } }),
    block({ category: "faqs", variant: "two", path: "veil/blocks/faqs/two.tsx", dependencies: [ui("accordion")], meta: { "aspect-ratio": "60/19", width: 686, height: 217 } }),
    block({ category: "faqs", variant: "three", path: "veil/blocks/faqs/three.tsx", dependencies: [ui("accordion")], meta: { "aspect-ratio": "60/27", width: 686, height: 309 } }),
    ...
    block({ category: "faqs", variant: "five", path: "veil/blocks/faqs/five.tsx", dependencies: [ui("card"), ui("accordion")], meta: { "aspect-ratio": "60/38", width: 686, height: 434 } }),
